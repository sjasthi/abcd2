...
<div class="container">
    ...
    <form action="create_the_dress.php" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <label>Name</label> <br>
            <textarea style=width:400px class="form-control" name="description" cols="55" rows="5" required title="Please enter a Name"></textarea>
        </div>
        <div>
            <label>Description</label> <br>
            <textarea style=width:400px class="form-control" name="did_you_know" cols="55" rows="2" required title="Please enter a Description"></textarea>
        </div>
        <br><br>
